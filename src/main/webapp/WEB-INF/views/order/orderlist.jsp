...
<%@ include file="/WEB-INF/views/include/footer.jsp" %>
    ...
    <script type="text/javascript">
    	$(document).ready(function() {
    		...
    		function getList() {
				$.getJSON("/order/list/" + ${login.mno}, function(datas) {
					$(datas).each(function(i, data) {
						...
						str += "<div class='row'><div class='col-md-10 offset-md-1'><div class='jumbotron'><div class='row'><div class='col-md-4'><h5>주문번호</h5><h4>"
						...
						str += "</div><div class='row'><table class='table text-center'><thead><tr>"
							+ "<th><h4><strong>상품명</strong></h4></th><th><h4><strong>수량</strong></h4></th><th><h4>"
							+ "<strong>소계</strong></h4></th></tr></thead><tbody>";
							
						
						$(data.orderDetail).each(function(j, da) {
							str += "<tr><td>" + da.pname + "</td><td>"
								+ da.ocnt + "</td><td>" + da.result + "원</td></tr>";
						});//each
						
						str += "</tbody></table><div class='col-md-12 text-right'><h5>총 주문금액 : " + data.total + "원</h5>"
                        	+ "<a href='/order/detail?ordernumber=" + data.orderNumber + "'>자세히보기</a></div></div></div></div></div>";
			...
			function getDetail(ordernumber) {
				$.getJSON("/order/detail/" + ordernumber, function(data) {
					$(data).each(function() {
						...
						str += "<tr><td>" + this.pname + "</td><td>"
							+ this.ocnt + "</td><td>" + this.result + "원</td></tr>";
